...
function sil(e) {
    var socket = io.connect('/');
    socket.emit('sil', { nick: $('#nick').text(), msg: document.getElementById(e).innerHTML, oda: 'Haliç' });
    $("li[id*='" + e + "']").hide("slow");
...
function sikayetEtADD(e) {
    ...
    socket.emit('sikayetEtADD', { nick: nick, msg: document.getElementById(e).innerHTML, oda: 'Haliç' });
    $("li[id*='" + e + "']").hide(500);
